...
struct TRINITY_DLL_DECL npc_AkamaAI : public ScriptedAI
{
    ...
    void StartPreludeEvent()
    {
        ...
        Olum->GetMotionMaster()->MovePoint(0, OlumNewPos[0],OlumNewPos[1],OlumNewPos[2]);
    ...
    uint32 PreludeNextStep(uint32 Step)
    {
        ...
        switch(Step)
        {
            ...
            case 8:
                ...
                return 14500;
            case 9:
                m_creature->GetMotionMaster()->MovePoint(0, AkamaNewPos[0],AkamaNewPos[1],AkamaNewPos[2]);
                return 2500;
            case 10:
                if (olum)
            ...
            case 11:
                if (olum)
                {
                    ...
                    if (Creature* spirit = m_creature->SummonCreature(OLUMS_SPIRIT,OlumNewPos[0],OlumNewPos[1],OlumNewPos[2],OlumNewPos[3]-2.0f,TEMPSUMMON_TIMED_DESPAWN,16000))
                    {
                        ...
                        spirit->GetMotionMaster()->MovePoint(0, OlumNewPos[0],OlumNewPos[1],OlumNewPos[2]+8.0f);
                    }
                }
                return 7000;
            case 12:
                ...
                return 12000;
            case 13:
                m_creature->GetMotionMaster()->MovePoint(0, (AkamaPos[0]+0.1f), (AkamaPos[1]-0.1f), AkamaPos[2]);
                return 2100;
            case 14:
                m_creature->GetMotionMaster()->MovePoint(0, (AkamaPos[0]-0.05f), (AkamaPos[1]), AkamaPos[2]);    // just to turn back Akama to Illidan
                return 6000;
            case 15:
