...
struct TRINITY_DLL_DECL npc_squire_roweAI : public npc_escortAI
{
...
struct TRINITY_DLL_DECL npc_stormwind_elite_guardAI : public ScriptedAI
{
...
struct TRINITY_DLL_DECL npc_reginald_windsorAI : public npc_escortAI
{
