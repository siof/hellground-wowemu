...
class ChatHandler
{
    ...
    protected:
        ...
        bool HandleReloadLootTemplatesCommand(const char* args);
        bool HandleReloadLootGroupTemplatesCommand(const char* args);
        bool HandleReloadLootTypeTemplatesCommand(const char* args);
