...
enum MovementFlags
{
    ...
    MOVEFLAG_CAN_FLY            = 0x00800000,               // can fly in 2.4.3?
    MOVEFLAG_DESCENDING         = 0x01000000,               // proper ?
...
class MovementInfo
{
    public:
        MovementInfo() : moveFlags(MOVEFLAG_NONE), moveFlags2(MOVEFLAG2_NONE), time(0),
            t_time(0), t_time2(0), s_pitch(0.0f), fallTime(0), u_unk1(0.0f) {}

        // Read/Write methods
        void Read(ByteBuffer &data);
        void Write(ByteBuffer &data, bool full = true) const;
        ...
        uint32 const &GetTime() { return time; }
    ...
    private:
        ...
        uint8    moveFlags2;                                // see enum MovementFlags2
...
class TRINITY_DLL_SPEC Unit : public WorldObject
{
    public:
        ...
        bool isPossessed() const { return HasAuraType(SPELL_AURA_MOD_POSSESS) || HasAuraType(SPELL_AURA_MOD_POSSESS_PET); }
