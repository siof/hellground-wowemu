...
//                    case 30401: break;
                    ...
                    case 30427:
                    {
                        ...
                        if (caster->GetTypeId() ==TYPEID_PLAYER && target->GetTypeId() == TYPEID_UNIT && ((Creature*)target)->GetCreatureInfo()->type == CREATURE_TYPE_GAS_CLOUD)
                        {
                            ...
                            loot->clear();
                            loot->FillLoot(LOOT_TYPE_CREATURE_SKINNING, creature->GetEntry(), player, true);
    ...
    switch (m_modifier.m_auraname)
    {
        ...
        case SPELL_AURA_PERIODIC_DAMAGE_PERCENT:
        {
            ...
            if (m_modifier.m_auraname == SPELL_AURA_PERIODIC_DAMAGE)
            {
                ...
                if (GetSpellSchoolMask(GetSpellProto()) & SPELL_SCHOOL_MASK_NORMAL && GetEffectMechanic(GetSpellProto(), m_effIndex) != MECHANIC_BLEED)
                {
